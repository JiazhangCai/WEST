...
from util import sparse_mx_to_torch_edge_list, corruption, figure
...
class SpaceFlow(object):
    ...
    def preprocessing_data(self, n_top_genes=None, n_neighbors=10,flavor='cell_ranger',n_comps=50,adj=None):
        """
